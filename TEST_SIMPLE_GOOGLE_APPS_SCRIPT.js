// TEST SIMPLE Google Apps Script for Supercars Trivia
// This version only handles GET requests to test the connection
...
function doPost(e) {
  console.log("POST request received - redirecting to GET");
  return ContentService.createTextOutput(
    JSON.stringify({
      message: "Please use GET request instead of POST",
      method: "POST",
      suggestion: "Use GET request with URL parameters",
    })
  ).setMimeType(ContentService.MimeType.JSON);
}
