// FINAL FIXED Google Apps Script for Supercars Trivia with Region field
// This version handles undefined requests and fixes the setHeaders error
...
function doGet(e) {
  try {
    ...
    if (!e.parameter || !e.parameter.data) {
      console.error("No data parameter in GET request");
      return ContentService.createTextOutput(
        JSON.stringify({ success: false, error: "No data parameter" })
      ).setMimeType(ContentService.MimeType.JSON);
    }
    ...
    console.log("Parsed data from GET request:", data);
    console.log("Region value:", data.region);
    console.log("Region type:", typeof data.region);
