// TEST Google Apps Script for Supercars Trivia with Region field
// This version includes a test function you can run manually
...
// TEST FUNCTION - Run this to test the script manually
function testScript() {
  try {
